...
#from trl import build_bert_batch_from_txt, listify_batch
...
sentiment_pipe = pipeline("sentiment-analysis","lxyuan/distilbert-base-multilingual-cased-sentiments-student", device=pipe_device)
...
ppo_trainer = PPOTrainer(ppo_config, gpt2_model, gpt2_model_ref, gpt2_tokenizer, dataset=ds)
